...
class DashboardAjaxController extends AjaxController
{
    ...
    public function widgets(): void
    {
        ...
        $context = $widgets['context'] ?? $context;
        $rendered = [];
    ...
    private function context(): array
    {
        return [
            ...
            'active_company_id' => $_SESSION['user']['actual_society_id'] ?? $_SESSION['active_company_id'] ?? null,
            'active_brand_id' => $_SESSION['user']['actual_brand'] ?? $_SESSION['active_brand_id'] ?? null,
            'actual_service_id' => $_SESSION['user']['actual_service_id'] ?? null,
            'actual_team_id' => $_SESSION['user']['actual_team_id'] ?? null,
            'companies' => $_SESSION['available_companies'] ?? [],
            'brands' => $_SESSION['available_brands'] ?? [],
