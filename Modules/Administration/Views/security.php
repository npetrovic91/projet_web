                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button"
                                                        class="btn btn-xs btn-warning js-unblock"
                                                        data-unblock-type="ip"
                                                        data-unblock-id="<?= (int)$block['ibl_id'] ?>"
                                                        data-unblock-target="<?= $esc($block['ibl_ip']) ?>">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button"
                                                        class="btn btn-xs btn-warning js-unblock"
                                                        data-unblock-type="email"
                                                        data-unblock-id="<?= (int)$block['ebl_id'] ?>"
                                                        data-unblock-target="<?= $esc($block['ebl_email']) ?>">
                                                    <i class="fas fa-unlock"></i> Débloquer
                                                </button>
                                            </td>
                                        </tr>
...
function showUnblockModal(type, id, target) {
    ...
    form.action = type === 'ip' ? '/admin/security/unblock-ip/' + id : '/admin/security/unblock-email/' + id;
...
document.querySelectorAll('.js-unblock').forEach(function (button) {
    button.addEventListener('click', function () {
        showUnblockModal(button.dataset.unblockType, button.dataset.unblockId, button.dataset.unblockTarget);
    });
});
</script>
