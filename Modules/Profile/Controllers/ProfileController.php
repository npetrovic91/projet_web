...
class ProfileController extends BaseController
{
    ...
    public function changePassword(): void
    {
        ...
        if ($result['success']) {
            // Lever le verrou de changement de mot de passe dans la session
            // immédiatement, sans attendre une reconnexion.
            // AuthMiddleware::enforcePasswordChange() lit $_SESSION['security']['must_change_password'] :
            // si on ne le remet pas à false ici, l'utilisateur reste bloqué sur /profile
            // même après un changement réussi, jusqu'à déconnexion/reconnexion.
            $_SESSION['security']['must_change_password'] = false;
            unset($_SESSION['security']['requires_password_change']);
        }
        ...
        $this->flash(
            ...
            $result['success']
                ...
                : implode(' ', $result['errors'] ?? ['Erreur lors du changement de mot de passe.'])
        );
        $this->redirect('/profile');
    }
