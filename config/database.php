...
$_dbConfigs = [
    'development' => [
        ...
        'dbname'   => getenv('DB_DATABASE') ?: (getenv('DB_NAME') ?: 'autosav_dev'),
    ...
    'staging' => [
        ...
        'host'     => getenv('DB_HOST') ?: '127.0.0.1',
        'port'     => (int)(getenv('DB_PORT') ?: 3306),
        'dbname'   => getenv('DB_DATABASE') ?: (getenv('DB_NAME') ?: 'autosav_staging'),
        'user'     => getenv('DB_USERNAME') ?: (getenv('DB_USER') ?: 'autosav_stg'),
        'password' => getenv('DB_PASSWORD') ?: (getenv('DB_PASS') ?: ''),
        'charset'  => 'utf8mb4',
    ],
    'production' => [
        ...
        'host'     => getenv('DB_HOST') ?: '127.0.0.1',
        'port'     => (int)(getenv('DB_PORT') ?: 3306),
        'dbname'   => getenv('DB_DATABASE') ?: (getenv('DB_NAME') ?: 'autosav_prod'),
        'user'     => getenv('DB_USERNAME') ?: (getenv('DB_USER') ?: 'autosav_user'),
        'password' => getenv('DB_PASSWORD') ?: (getenv('DB_PASS') ?: ''),
        'charset'  => 'utf8mb4',
    ],
];
...
if (defined('PDO::MYSQL_ATTR_INIT_COMMAND')) {
    $_pdoOptions[PDO::MYSQL_ATTR_INIT_COMMAND] = "SET NAMES utf8mb4 COLLATE utf8mb4_unicode_ci";
}
define('DB_PDO_OPTIONS', $_pdoOptions);
unset($_pdoOptions);
