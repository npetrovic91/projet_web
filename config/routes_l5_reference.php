...
$routes[] = ['method' => 'GET',  'uri' => '/companies/types',               'controller' => 'Companies\Controllers\CompanyController', 'action' => 'types',         'middleware' => ['auth']];
$routes[] = ['method' => 'GET',  'uri' => '/companies/types/create',        'controller' => 'Companies\Controllers\CompanyController', 'action' => 'createType',    'middleware' => ['auth']];
$routes[] = ['method' => 'POST', 'uri' => '/companies/types/store',         'controller' => 'Companies\Controllers\CompanyController', 'action' => 'storeType',     'middleware' => ['auth', 'csrf']];
$routes[] = ['method' => 'GET',  'uri' => '/companies/types/{id:\d+}/edit', 'controller' => 'Companies\Controllers\CompanyController', 'action' => 'editType',      'middleware' => ['auth']];
$routes[] = ['method' => 'POST', 'uri' => '/companies/types/{id:\d+}/update','controller' => 'Companies\Controllers\CompanyController', 'action' => 'updateType',    'middleware' => ['auth', 'csrf']];
$routes[] = ['method' => 'POST', 'uri' => '/companies/types/{id:\d+}/delete','controller' => 'Companies\Controllers\CompanyController', 'action' => 'deleteType',    'middleware' => ['auth', 'csrf']];
