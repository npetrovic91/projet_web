...
abstract class BaseController
{
    ...
    protected function requirePermission(string $permission): void
    {
        ...
        // Centralise les alias et la règle super-admin dans AuthHelper::has_permission().
    ...
    protected function activeCompanyId(): ?int
    {
        foreach ([
            ...
            $_SESSION['active_concession_id'] ?? null,
            $_SESSION['user']['actual_society_id'] ?? null,
            $_SESSION['user']['actual_concession_id'] ?? null,
            $_SESSION['society']['id'] ?? null,
            $_SESSION['society']['soc_id'] ?? null,
            $_SESSION['concession']['id'] ?? null,
            $_SESSION['concession']['soc_id'] ?? null,
        ] as $value) {
            $id = (int) $value;
            if ($id > 0) {
                return $id;
    ...
    protected function activeBrandId(): ?int
    {
        foreach ([
            ...
            $_SESSION['marque']['id'] ?? null,
            $_SESSION['marque']['soc_id'] ?? null,
        ] as $value) {
            $id = (int) $value;
            if ($id > 0) {
                return $id;
